...
def osd_sink_pad_buffer_probe(pad,info,u_data):
    ...
    while l_frame is not None:
        ...
        while l_obj is not None:
            ...
            if debug: print(obj_meta.class_id)

            l_class = obj_meta.classifier_meta_list
            if debug: print(l_class)
            
            if l_class is not None:
                if debug: print("There's SOME metadata!")
                try:
                ...
                if l_label is not None:
                        try:
                            ...
                            break
                if debug: print("Result:", label_info.result_label)
                if debug: print("Result:", label_info.result_prob)
                #input("mira")
...
def main(args):
    ...
    pgie.set_property('config-file-path', "yolov7_config.txt")
