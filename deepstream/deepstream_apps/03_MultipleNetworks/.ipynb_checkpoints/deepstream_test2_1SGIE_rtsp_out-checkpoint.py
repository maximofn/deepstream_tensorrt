...
def parse_args():
    ...
    parser.add_argument("-x", "--primary_config_file", default="dstest2_pgie_config.txt", help="Config file, default=dstest2_pgie_config.txt")
...
######  
    ...
    sgie1.link(nvvidconv) #sgie1-nvvidconv
