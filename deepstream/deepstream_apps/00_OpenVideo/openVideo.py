...
########################################################################################################################################################################################################################################
#   _________          _____________          _______________          _____________          ________________          _________          ________________          ____________          _______________          ____________          _________
#  |         |        | h264        |        |               |        |             |        |                |        |         |        |                |        |            |        |               |        |            |        |         |
#  | filesrc |------->|  /   parser |------->| nvv4l2decoder |------->| nvstreammux |------->| nvvideoconvert |------->| nvdsosd |------->| nvvideoconvert |------->| capsfilter |------->| nvv4l2h264enc |------->| rtph264pay |------->| udpsink |
#  |_________|        |_h265________|        |_______________|        |_____________|        |________________|        |_________|        |________________|        |____________|        |_______________|        |____________|        |_________|
#
#   open video         parse video            decode video             forms a batch          convert video             draw overlay       convert video            not modify data         encode video            Payload-encode       sends UDP packets 
#                                             h264/h265 to nv12        of frames from         nv12 to RGBA              bounding boxes     RGBA to nv12             but can enforce         nv12 to h264/h265       H264 video into      to the network
#                                                                      multiple input                                                                               limitations on                                  RTP packets
