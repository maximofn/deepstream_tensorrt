...
def osd_sink_pad_buffer_probe(pad,info,u_data):
    ...
    while l_frame is not None:
        ...
        py_nvosd_text_params.display_text = "Frame Number={} Number of Objects={} Vehicle_count={} Bycicle_count={}".format(frame_number, num_rects, obj_counter[PGIE_CLASS_ID_VEHICLE], obj_counter[PGIE_CLASS_ID_BICYCLE])
