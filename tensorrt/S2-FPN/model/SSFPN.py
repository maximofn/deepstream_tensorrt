...
from torchvision.models import resnet34, resnet50, resnet101, resnet152, resnet18, ResNet18_Weights, ResNet34_Weights, ResNet50_Weights, ResNet101_Weights, ResNet152_Weights
...
class SSFPN(nn.Module):
    def __init__(self, backbone,
        ...
        if backbone.lower() == "resnet18":
            ...
            encoder = resnet152(weights=ResNet152_Weights.DEFAULT)
        else:
